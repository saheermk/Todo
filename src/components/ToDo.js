            ...
            <ListItem>
                <LeftContainer>
                    <CheckContainerCompleted>
                        <TickImage src={require('./assets/tick-green.svg').default} alt="Tick Image"  onClick={()=>revertTask(task.id)}/>
                    </CheckContainerCompleted>
                    <ItemContentCompleted>{task.id}, {task.title}</ItemContentCompleted>
                </LeftContainer>
                <RightContainer>
                    <ActionButton>
                        <ButtonImage src={require('./assets/revert.svg').default} alt="revert"  onClick={()=>revertTask(task.id)}/>
                    </ActionButton>
